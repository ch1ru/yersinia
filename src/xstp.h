...
struct commands_param xstp_comm_params[] = {
    ...
    { XSTP_FWD, "forward",   "Fwd", 2, FIELD_HEX, "Set the forward delay for the spanning tree", 
       ...
       { XSTP_LEN, "v1-length",   "v1len", 1, FIELD_HEX, "Length of standard spanning tree (v1) frame", 
                       " <00-FF>    version 1 length", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_LEN, "v3-length",   "v3len", 2, FIELD_HEX, "Length of standard spanning tree (v3) frame", 
                       " <00-FFFF>    version 3 length", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_CONF_ID, "confid",   "confid", 1, FIELD_HEX, "Configuration identifier", 
                       " <00-FF>    id", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_CONF_NAME, "confname",   "confname", 32, FIELD_HEX, "Configuration name", 
                       " <00-FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF>    config name", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_CONF_REV, "confrev",   "confrev", 2, FIELD_HEX, "Configuration rev", 
                       " <00-FFFF>    conf rev", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_CONF_DIGEST, "confdigest",   "confdigest", 16, FIELD_HEX, "Configuration digest", 
                       " <00-FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF>    configuration digest", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_INT_PATHCOST, "intpc",   "intpc", 4, FIELD_HEX, "Cost of the network edge", 
                       " <00-FFFFFFFF>    internal path cost", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_BRIDGEID, "cistbridgeid",   "cistbridgeid", 8, FIELD_BRIDGEID, "Bridge id for cist", 
                       " HH.HHHHHH    bridge id", 4, 3, 0, xstp_com_other, NULL },
       { MSTP_HOPS, "hops",   "hops", 1, FIELD_HEX, "Remaining hops", 
                       " <00-FF>    number of hops left", 4, 3, 0, xstp_com_other, NULL },
